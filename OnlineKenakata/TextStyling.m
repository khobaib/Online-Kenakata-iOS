...
+(UIColor *)appColor{
    // online kenakata return [UIColor colorWithRed:(90.0/255.0) green:(74.0/255.0) blue:(66.0/255.0) alpha:1.0];
    
    //sigma
    
    return [UIColor colorWithRed:(68.0/255.0) green:(146.0/255.0) blue:(200.0/255.0) alpha:1.0];
